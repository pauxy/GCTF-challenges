...
4.	going into admin, you will notice that you can choose option b and print flag, however, it requires a password
...
6.	therefore, after entering `635` you get the flag
